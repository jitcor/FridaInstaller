...
import com.github.ihbing.frida.installer.util.HashUtil;
...
import com.github.ihbing.frida.installer.widget.DownloadView;
...
public class DownloadDetailsVersionsFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (module.versions.isEmpty()) {
            setEmptyText(getString(com.github.ihbing.frida.installer.R.string.download_no_versions));
            setListShown(true);
        } else {
            RepoLoader repoLoader = RepoLoader.getInstance();
            if (!repoLoader.isVersionShown(module.versions.get(0))) {
                TextView txtHeader = new TextView(getActivity());
                txtHeader.setText(com.github.ihbing.frida.installer.R.string.download_test_version_not_shown);
                txtHeader.setTextColor(getResources().getColor(com.github.ihbing.frida.installer.R.color.warning));
    ...
    public static class DownloadModuleCallback implements DownloadsUtil.DownloadFinishedCallback {
        ...
        public void onDownloadFinished(Context context,
            ...
            if (moduleVersion.md5sum != null && !moduleVersion.md5sum.isEmpty()) {
                try {
                    ...
                    if (!moduleVersion.md5sum.equals(actualMd5Sum)) {
                        Toast.makeText(context, context.getString(com.github.ihbing.frida.installer.R.string.download_md5sum_incorrect, actualMd5Sum, moduleVersion.md5sum), Toast.LENGTH_LONG).show();
                        DownloadsUtil.removeById(context, info.id);
                        return;
                    }
                } catch (Exception e) {
                    Toast.makeText(context, context.getString(com.github.ihbing.frida.installer.R.string.download_could_not_read_file, e.getMessage()), Toast.LENGTH_LONG).show();
                    DownloadsUtil.removeById(context, info.id);
                    return;
                }
            }
            ...
            if (packageInfo == null) {
                Toast.makeText(context, com.github.ihbing.frida.installer.R.string.download_no_valid_apk, Toast.LENGTH_LONG).show();
                DownloadsUtil.removeById(context, info.id);
                return;
            }
            ...
            if (!packageInfo.packageName
                ...
                Toast.makeText(context, context.getString(com.github.ihbing.frida.installer.R.string.download_incorrect_package_name, packageInfo.packageName, moduleVersion.module.packageName), Toast.LENGTH_LONG).show();
                DownloadsUtil.removeById(context, info.id);
                return;
            }
    ...
    private class VersionsAdapter extends ArrayAdapter<ModuleVersion> {
        ...
        public VersionsAdapter(Context context, InstalledModule installed) {
            super(context, com.github.ihbing.frida.installer.R.layout.list_item_version);
            mColorRelTypeStable = ThemeUtil.getThemeColor(context, android.R.attr.textColorTertiary);
            mColorRelTypeOthers = getResources().getColor(com.github.ihbing.frida.installer.R.color.warning);
            mColorInstalled = ThemeUtil.getThemeColor(context, com.github.ihbing.frida.installer.R.attr.download_status_installed);
            mColorUpdateAvailable = getResources().getColor(com.github.ihbing.frida.installer.R.color.download_status_update_available);
            mTextInstalled = getString(com.github.ihbing.frida.installer.R.string.download_section_installed) + ":";
            mTextUpdateAvailable = getString(com.github.ihbing.frida.installer.R.string.download_section_update_available) + ":";
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                view = inflater.inflate(com.github.ihbing.frida.installer.R.layout.list_item_version, null, true);
                ViewHolder viewHolder = new ViewHolder();
                viewHolder.txtStatus = (TextView) view.findViewById(com.github.ihbing.frida.installer.R.id.txtStatus);
                viewHolder.txtVersion = (TextView) view.findViewById(com.github.ihbing.frida.installer.R.id.txtVersion);
                viewHolder.txtRelType = (TextView) view.findViewById(com.github.ihbing.frida.installer.R.id.txtRelType);
                viewHolder.txtUploadDate = (TextView) view.findViewById(com.github.ihbing.frida.installer.R.id.txtUploadDate);
                viewHolder.downloadView = (DownloadView) view.findViewById(com.github.ihbing.frida.installer.R.id.downloadView);
                viewHolder.txtChangesTitle = (TextView) view.findViewById(com.github.ihbing.frida.installer.R.id.txtChangesTitle);
                viewHolder.txtChanges = (TextView) view.findViewById(com.github.ihbing.frida.installer.R.id.txtChanges);
