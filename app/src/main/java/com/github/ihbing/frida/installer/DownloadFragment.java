...
import com.github.ihbing.frida.installer.repo.RepoDbDefinitions.OverviewColumnsIndexes;
import com.github.ihbing.frida.installer.util.Loader;
...
public class DownloadFragment extends Fragment implements Loader.Listener<RepoLoader>, ModuleListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(com.github.ihbing.frida.installer.R.layout.tab_downloader, container, false);

        mRefreshHint = v.findViewById(com.github.ihbing.frida.installer.R.id.refresh_hint);
        final SwipeRefreshLayout refreshLayout = (SwipeRefreshLayout) v.findViewById(com.github.ihbing.frida.installer.R.id.swiperefreshlayout);
        refreshLayout.setColorSchemeColors(getResources().getColor(com.github.ihbing.frida.installer.R.color.colorPrimary));
        mRepoLoader.addListener(this);
        mRepoLoader.setSwipeRefreshLayout(refreshLayout);
        mModuleUtil.addListener(this);

        mListView = (StickyListHeadersListView) v.findViewById(com.github.ihbing.frida.installer.R.id.listModules);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(com.github.ihbing.frida.installer.R.menu.menu_download, menu);

        // Setup search button
        final MenuItem searchItem = menu.findItem(com.github.ihbing.frida.installer.R.id.menu_search);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.github.ihbing.frida.installer.R.id.menu_sort:
                new MaterialDialog.Builder(getActivity())
                        .title(com.github.ihbing.frida.installer.R.string.download_sorting_title)
                        .items(com.github.ihbing.frida.installer.R.array.download_sort_order)
    ...
    private class DownloadsAdapter extends CursorAdapter implements StickyListHeadersAdapter {
        ...
        public DownloadsAdapter(Context context) {
            ...
            sectionHeadersStatus = new String[]{
                    res.getString(com.github.ihbing.frida.installer.R.string.download_section_framework),
                    res.getString(com.github.ihbing.frida.installer.R.string.download_section_update_available),
                    res.getString(com.github.ihbing.frida.installer.R.string.download_section_installed),
                    res.getString(com.github.ihbing.frida.installer.R.string.download_section_not_installed),};
            sectionHeadersDate = new String[]{
                    res.getString(com.github.ihbing.frida.installer.R.string.download_section_24h),
                    res.getString(com.github.ihbing.frida.installer.R.string.download_section_7d),
                    res.getString(com.github.ihbing.frida.installer.R.string.download_section_30d),
                    res.getString(com.github.ihbing.frida.installer.R.string.download_section_older)};
        }

        @Override
        public View getHeaderView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = mInflater.inflate(com.github.ihbing.frida.installer.R.layout.list_sticky_header_download, parent, false);
            }
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            return mInflater.inflate(com.github.ihbing.frida.installer.R.layout.list_item_download, parent, false);
        }
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            TextView txtStatus = (TextView) view.findViewById(com.github.ihbing.frida.installer.R.id.downloadStatus);
            if (hasUpdate) {
                txtStatus.setText(mContext.getString(
                        com.github.ihbing.frida.installer.R.string.download_status_update_available,
                        installedVersion, latestVersion));
                txtStatus.setTextColor(getResources().getColor(com.github.ihbing.frida.installer.R.color.download_status_update_available));
                txtStatus.setVisibility(View.VISIBLE);
            } else if (isInstalled) {
                txtStatus.setText(mContext.getString(
                        com.github.ihbing.frida.installer.R.string.download_status_installed, installedVersion));
                txtStatus.setTextColor(ThemeUtil.getThemeColor(mContext, com.github.ihbing.frida.installer.R.attr.download_status_installed));
                txtStatus.setVisibility(View.VISIBLE);
            } else {
            ...
            ((TextView) view.findViewById(com.github.ihbing.frida.installer.R.id.timestamps)).setText(getString(com.github.ihbing.frida.installer.R.string.download_timestamps, creationDate, updateDate));
        }
    }
}
