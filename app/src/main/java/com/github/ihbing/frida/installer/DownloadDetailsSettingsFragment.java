...
import com.github.ihbing.frida.installer.util.PrefixedSharedPreferences;
...
public class DownloadDetailsSettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.github.ihbing.frida.installer.R.xml.module_prefs);
