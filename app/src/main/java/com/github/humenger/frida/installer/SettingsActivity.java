...
public class SettingsActivity extends XposedBaseActivity implements FolderChooserDialog.FolderCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ab != null) {
            ab.setTitle(com.github.humenger.frida.installer.R.string.nav_item_settings);
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .add(com.github.humenger.frida.installer.R.id.container, new SettingsFragment()).commit();
        }
    ...
    public void onFolderSelection(@NonNull FolderChooserDialog dialog, @NonNull File folder) {
        if (folder.canWrite()) {
            ...
            Toast.makeText(this, com.github.humenger.frida.installer.R.string.sdcard_not_writable, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public static class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceClickListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(com.github.humenger.frida.installer.R.xml.prefs);
