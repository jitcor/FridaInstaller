...
public class DownloadDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(com.github.humenger.frida.installer.R.layout.download_details, container, false);

        TextView title = (TextView) view.findViewById(com.github.humenger.frida.installer.R.id.download_title);
        title.setText(module.name);

        TextView author = (TextView) view.findViewById(com.github.humenger.frida.installer.R.id.download_author);
        if (module.author != null && !module.author.isEmpty())
            author.setText(getString(com.github.humenger.frida.installer.R.string.download_author, module.author));
        else
            author.setText(com.github.humenger.frida.installer.R.string.download_unknown_author);

        TextView description = (TextView) view
                .findViewById(com.github.humenger.frida.installer.R.id.download_description);
        ...
        ViewGroup moreInfoContainer = (ViewGroup) view.findViewById(com.github.humenger.frida.installer.R.id.download_moreinfo_container);
        for (Pair<String, String> moreInfoEntry : module.moreInfo) {
            View moreInfoView = inflater.inflate(com.github.humenger.frida.installer.R.layout.download_moreinfo, moreInfoContainer, false);
