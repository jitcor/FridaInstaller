...
import com.github.humenger.frida.installer.util.PrefixedSharedPreferences;
...
public class DownloadDetailsSettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.github.humenger.frida.installer.R.xml.module_prefs);
