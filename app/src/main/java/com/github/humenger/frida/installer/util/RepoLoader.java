...
import com.github.humenger.frida.installer.repo.Repository;
...
public class RepoLoader extends OnlineLoader<RepoLoader> {
    ...
    private boolean downloadAndParseFiles(List<String> messages) {
        ...
        for (Entry<Long, Repository> repoEntry : mRepositories.entrySet()) {
            ...
            if (info.status != DownloadsUtil.SyncDownloadInfo.STATUS_SUCCESS) {
            ...
            try {
                ...
                RepoParser.parse(in, new RepoParser.RepoParserCallback() {
                    @Override
