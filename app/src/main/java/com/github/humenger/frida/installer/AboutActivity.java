...
public class AboutActivity extends XposedBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ab != null) {
            ab.setTitle(com.github.humenger.frida.installer.R.string.nav_item_about);
            ab.setDisplayHomeAsUpEnabled(true);
        }

        setFloating(toolbar, com.github.humenger.frida.installer.R.string.nav_item_about);

        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction().add(com.github.humenger.frida.installer.R.id.container, new AboutFragment()).commit();
        }
    }
    ...
    public static class AboutFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View v = inflater.inflate(com.github.humenger.frida.installer.R.layout.tab_about, container, false);

            View developersView = v.findViewById(com.github.humenger.frida.installer.R.id.developersView);
            View licensesView = v.findViewById(com.github.humenger.frida.installer.R.id.licensesView);
            View translatorsView = v.findViewById(com.github.humenger.frida.installer.R.id.translatorsView);
            View sourceCodeView = v.findViewById(com.github.humenger.frida.installer.R.id.sourceCodeView);

            String packageName = getActivity().getPackageName();
            String translator = getResources().getString(com.github.humenger.frida.installer.R.string.translator);

            try {
                String version = getActivity().getPackageManager().getPackageInfo(packageName, 0).versionName;
                ((TextView) v.findViewById(com.github.humenger.frida.installer.R.id.app_version)).setText(version);
            ...
            developersView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                            .title(com.github.humenger.frida.installer.R.string.about_developers_label)
                            .content(com.github.humenger.frida.installer.R.string.about_developers)
                            .positiveText(android.R.string.ok)
                            .show();

                    ((TextView) dialog.findViewById(com.github.humenger.frida.installer.R.id.md_content)).setMovementMethod(LinkMovementMethod.getInstance());
                }
            });
            ...
            sourceCodeView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    NavUtil.startURL(getActivity(), getString(com.github.humenger.frida.installer.R.string.about_source));
                }
            });
