...
public class DownloadDetailsActivity extends XposedBaseActivity implements Loader.Listener<RepoLoader>, ModuleListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mModule != null) {
            setContentView(com.github.humenger.frida.installer.R.layout.activity_download_details);
            ...
            if (ab != null) {
                ab.setTitle(com.github.humenger.frida.installer.R.string.nav_item_download);
            ...
            if (Build.VERSION.SDK_INT >= 21)
                findViewById(com.github.humenger.frida.installer.R.id.fake_elevation).setVisibility(View.GONE);

        } else {
            setContentView(com.github.humenger.frida.installer.R.layout.activity_download_details_not_found);

            TextView txtMessage = (TextView) findViewById(android.R.id.message);
            txtMessage.setText(getResources().getString(com.github.humenger.frida.installer.R.string.download_details_not_found, mPackageName));

            findViewById(com.github.humenger.frida.installer.R.id.reload).setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private void setupTabs() {
        mPager = (ViewPager) findViewById(com.github.humenger.frida.installer.R.id.download_pager);
        mPager.setAdapter(new SwipeFragmentPagerAdapter(getFragmentManager()));
        TabLayout mTabLayout = (TabLayout) findViewById(com.github.humenger.frida.installer.R.id.sliding_tabs);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.github.humenger.frida.installer.R.menu.menu_download_details, menu);

        // TODO maybe enable again after checking the implementation
        menu.findItem(com.github.humenger.frida.installer.R.id.menu_bookmark).setVisible(false);
        menu.findItem(com.github.humenger.frida.installer.R.id.menu_share).setVisible(false);
    ...
    private void setupBookmark(boolean clicked) {
        ...
        if (clicked) {
            ...
            int msg = newValue ? com.github.humenger.frida.installer.R.string.bookmark_added : com.github.humenger.frida.installer.R.string.bookmark_removed;
        ...
        if (saved) {
            mItemBookmark.setTitle(com.github.humenger.frida.installer.R.string.remove_bookmark);
            mItemBookmark.setIcon(com.github.humenger.frida.installer.R.drawable.ic_bookmark);
        } else {
            mItemBookmark.setTitle(com.github.humenger.frida.installer.R.string.add_bookmark);
            mItemBookmark.setIcon(com.github.humenger.frida.installer.R.drawable.ic_bookmark_outline);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.github.humenger.frida.installer.R.id.menu_bookmark:
                setupBookmark(true);
                break;
            case com.github.humenger.frida.installer.R.id.menu_refresh:
                RepoLoader.getInstance().triggerReload(true);
                return true;
            case com.github.humenger.frida.installer.R.id.menu_share:
                ...
                startActivity(Intent.createChooser(sharingIntent, getString(com.github.humenger.frida.installer.R.string.share)));
                return true;
        }
    ...
    class SwipeFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        private String tabTitles[] = new String[]{getString(com.github.humenger.frida.installer.R.string.download_details_page_description), getString(com.github.humenger.frida.installer.R.string.download_details_page_versions), getString(com.github.humenger.frida.installer.R.string.download_details_page_settings),};
