...
public class LogsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.github.h.f.installer.R.layout.tab_logs, container, false);
        mTxtLog = (TextView) v.findViewById(com.github.h.f.installer.R.id.txtLog);
        mTxtLog.setTextIsSelectable(true);
        mSVLog = (ScrollView) v.findViewById(com.github.h.f.installer.R.id.svLog);
        mHSVLog = (HorizontalScrollView) v.findViewById(com.github.h.f.installer.R.id.hsvLog);
        reloadErrorLog();
/*
...
*/
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(com.github.h.f.installer.R.menu.menu_logs, menu);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case com.github.h.f.installer.R.id.menu_scroll_top:
                scrollTop();
                break;
            case com.github.h.f.installer.R.id.menu_scroll_down:
                scrollDown();
                break;
            case com.github.h.f.installer.R.id.menu_refresh:
                reloadErrorLog();
                return true;
            case com.github.h.f.installer.R.id.menu_send:
                try {
                    send();
                } catch (NullPointerException ignored) {
                }
                return true;
            case com.github.h.f.installer.R.id.menu_save:
                save();
                return true;
            case com.github.h.f.installer.R.id.menu_clear:
                clear();
                return true;
        }
    ...
    private void clear() {
        try {
            ...
            mTxtLog.setText(com.github.h.f.installer.R.string.log_is_empty);
            Toast.makeText(getActivity(), com.github.h.f.installer.R.string.logs_cleared,
                    Toast.LENGTH_SHORT).show();
            reloadErrorLog();
        } catch (IOException e) {
            Toast.makeText(getActivity(), getResources().getString(com.github.h.f.installer.R.string.logs_clear_failed) + "n" + e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void send() {
        ...
        startActivity(Intent.createChooser(sendIntent, getResources().getString(com.github.h.f.installer.R.string.menuSend)));
    }
    ...
    private class LogsReader extends AsyncTask<File, Integer, String> {
        ...
        protected void onPreExecute() {
            mProgressDialog = new MaterialDialog.Builder(getActivity()).content(com.github.h.f.installer.R.string.loading).progress(true, 0).show();
        }
